	...
	function imprime_elementos(){
		...
		var elemento_magazine='<tr><td width="30px">&nbsp;&nbsp;%index%</td><td width="100px"><img src="'+ URL_BASE_IMAGENES +'%imagen%" width="70px" height="40px" /></td><td width="500px"><input type="text" name="linkNoticia%index%" id="linkNoticia%index%" value="%nombre%" disabled size="60"></td><td width="100px">%controles%</td></tr>';
